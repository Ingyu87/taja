    ...
    return (
        <div className="min-h-screen flex flex-col bg-gradient-to-b from-green-100 to-cyan-100 p-8">
            ...
            <div className="flex-1 relative bg-white rounded-[40px] shadow-2xl overflow-hidden" style={{ minHeight: '600px' }}>
                {gameState === 'ready' && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-green-200 to-cyan-200">
                        <h1 className="text-7xl font-black text-green-600 mb-6">⏰ 시간 공격 게임</h1>
                        <p className="text-3xl font-bold text-gray-700 mb-4">30초 안에 최대한 많은 단어를 치세요!</p>
                        <p className="text-2xl text-gray-600 mb-12">연속으로 맞추면 콤보 점수 획득!</p>
                        <button
                            onClick={startGame}
                ...
                {gameState === 'playing' && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-12">
                        {/* 콤보 표시 */}
                        {combo >= 3 && (
                            <div className="mb-8 text-6xl font-black text-orange-600 animate-pulse">
                                {combo} COMBO! 🔥
                            </div>
                        )}

                        {/* 목표 단어 */}
                        <div className="bg-gradient-to-br from-blue-400 to-purple-400 text-white px-20 py-12 rounded-[40px] shadow-2xl mb-12">
                            <div className="text-8xl font-black text-center" style={{ letterSpacing: '0.1em' }}>
                        ...
                        <input
                            ...
                            className="w-full max-w-3xl px-12 py-8 text-6xl text-center border-8 focus:outline-none focus:ring-8 focus:ring-green-200 font-black rounded-full"
                            style={{ 
                ...
                {gameState === 'gameover' && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200">
                        <h2 className="text-7xl font-black text-green-600 mb-6">시간 종료! ⏰</h2>
                        <div className="bg-white p-12 rounded-[40px] shadow-2xl mb-8">
                            <p className="text-4xl font-black text-gray-800 mb-4">최종 점수: <span className="text-green-600">{score}</span></p>
                            <p className="text-3xl font-bold text-gray-700 mb-2">최고 콤보: {maxCombo}연속</p>
                            <p className="text-3xl font-bold text-gray-700 mb-2">도달 레벨: {level}</p>
                            <p className="text-3xl font-bold text-gray-700">정확도: {totalTyped > 0 ? Math.round((correctTyped / totalTyped) * 100) : 100}%</p>
                        </div>
