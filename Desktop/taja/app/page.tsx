      ...
      <div className="text-center max-w-2xl mx-auto flex flex-col gap-0 w-full">
        ...
        <div className="flex flex-col w-full">
          ...
          <div
            ...
            className="bg-white p-4 cursor-pointer hover:bg-gray-50 transition-colors border-b-2"
            style={{ borderColor: '#9B59B6' }}
          >
            <div className="flex items-start gap-3">
              <span style={{ fontSize: '2.5rem' }}>👑</span>
              <div className="flex-1 text-left">
                <h2 className="text-xl font-bold mb-2" style={{ color: '#5D4E6D' }}>시작하기</h2>
                <p className="text-sm mb-3" style={{ color: '#5D4E6D' }}>재미있는 타자 왕국으로 입장하세요!</p>
                <span className="text-sm px-4 py-2 inline-block rounded-full font-bold" style={{ 
          ...
          {/* 섹션 2: 단계별 연습 */}
          <div className="bg-white p-4 border-b-2" style={{ borderColor: '#9B59B6' }}>
            <div className="flex items-start gap-3">
              <span style={{ fontSize: '2.5rem' }}>📚</span>
              <div className="flex-1 text-left">
